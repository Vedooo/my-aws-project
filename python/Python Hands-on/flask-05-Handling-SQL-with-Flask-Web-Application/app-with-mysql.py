...
app.config['MYSQL_DATABASE_HOST'] = 'vedodb.ccl8yxbfrine.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'vedovedo1'
app.config['MYSQL_DATABASE_DB'] = 'expdb'
